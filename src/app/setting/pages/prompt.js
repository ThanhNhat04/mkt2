            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
              ...
              <Box sx={{ display: 'flex', flexDirection: 'row', gap: 2, justifyContent: 'center' }}>
                <Button
                  ...
                  sx={{
                    width:'max-content',backgroundColor: '#primary.main', color: 'white', padding: '12px', '&:hover': { backgroundColor: 'primary.dark' }
                  }}
                >
                  Cập nhập
                </Button>
                <Button
                  ...
                  disabled={!selectedPrompt}
                  sx={{
                    width:'max-content',backgroundColor: 'red', color: 'white', padding: '12px', '&:hover': { backgroundColor: 'darkred' }
                  }}
                >
                  Xóa
                </Button>
